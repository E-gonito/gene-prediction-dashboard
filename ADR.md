...
Data object is flat, either is fine. But, interfaces are extendable via declaration merging and conventionally used for object/contract shapes; type aliases handle unions, intersections, and primitives that interfaces can't. 
Type is used for this project.
